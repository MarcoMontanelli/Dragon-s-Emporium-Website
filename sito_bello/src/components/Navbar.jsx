...
function DropValue({ value, link }) {
  return (
    <li>
      <a
        href={link}
        className="block px-4 py-2 hover:bg-electric-violet text-white"
      >
        {value}
      </a>
    </li>
      ...
      <div className="flex lg:order-2">
        <div class="relative hidden lg:block">
          ...
          <input
            type="text"
            id="search-navbar"
            class="block w-full p-2 ps-10 text-sm text-blackk border-electric-violet rounded-lg focus:ring-electric-violet focus:border-electric-violet "
            placeholder="Search..."
          />
        </div>
      </div>
        ...
        <ul class="flex flex-col p-4 mt-4 font-medium border rounded-lg">
          <li>
            <div className="flex flex-col relative z-50">
              <button
                class="flex object-fill py-2 px-3 rounded hover:bg-electric-violet text-white"
                type="button"
          ...
          <li>
            <a
              href="../../shop.html"
              class="block py-2 px-3 rounded hover:bg-electric-violet text-white"
            >
              Shop
            </a>
          </li>
