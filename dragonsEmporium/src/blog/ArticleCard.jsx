...
const Article = ({ category, title, date, description, imageUrl }) => {
  ...
  return (
    <motion.div className="bg-gray-900 border border-gray-700 text-white p-6 rounded-xl mx-auto  w-full my-8 shadow-lg transition-shadow duration-300 hover:shadow-2xl"
