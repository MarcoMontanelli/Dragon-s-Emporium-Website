...
function Drawer({onClose, isDrawerOpen}) {
  // Drawer component content with close functionality managed by React
  return (
    <div
    id="drawer-backdrop"
    className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto bg-blackk w-64 bg-gray-800 transition-transform ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
    tabIndex="-1"
  ...
  >
      ...
      <button type="button" data-drawer-hide="drawer-backdrop" aria-controls="drawer-backdrop" class="text-gray-100 bg-transparent hover:bg-gray-200 hover:text-gray-200 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-100 dark:hover:text-white" onClick={onClose} >
...
export default function GridArticle() {
  ...
  return (
    <>
      ...
      {isDrawerOpen && <Drawer onClose={toggleDrawer} isDrawerOpen={isDrawerOpen} />}
