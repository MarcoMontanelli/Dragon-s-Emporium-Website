  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center mt-4 ">
            ...
            <div className="lg:w-1/2 max-w-4xl mx-auto lg:mx-0 my-12 lg:my-0 p-1 rounded-t-md justify-center gradient-shadow">
            <div class="max-w-6xl mx-auto font-[sans-serif] text-[#333]">

                  <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 p-4 mb-2 mt-2">
                    <div class="p-4 text-center text-white rounded-lg shadow-xl bg-gradient-to-r from-black via-slate-800 to-black shadow-purple-700/50 border border-gray-600 ">
                    ...
                    <div class="p-4 text-center text-white bg-gradient-to-r from-black via-slate-800 to-black rounded-lg shadow-xl shadow-purple-700/50 border border-gray-600">
            ...
            <section className="md:w-1/2  flex items-center justify-center">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    ...
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
                        We always try to prode the best service in any case, we offer top tier commissions featuring custom designs at an affordable pricepoint, we are always here to answer your questions, just send us a message
                    </p>
